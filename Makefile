...
APPNAME=mtb-example-psoc6-matter-door-lock
...
# The user may want to make a local copy of the zap files and modify them.  When that is done, this
# variable should be set to false.  After that is done, any time that the matter library is updated,
# information from the versions of these files in that library may need to be merged into the local
# versions of these files.
CY_USE_DEFAULT_MATTER_ZAP=true
